...
<html>
    ...
    <body>
        ...
        <tbody>
            ...
            <c:forEach items="${allapolices}" var="apolice">
                <tr>
                    <td><c:out value="${apolice.id_apolice}" /></td>
                    <td><fmt:formatDate pattern="dd-MM-yyyy" value="${apolice.data_inicio}" /></td>
                    <td><fmt:formatDate pattern="dd-MM-yyyy" value="${apolice.data_fim}" /></td>
